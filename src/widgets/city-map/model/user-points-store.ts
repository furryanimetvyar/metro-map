...
export const userPointsStore = create<MapEditableStore>()(
  persist(
    (set) => ({
      ...
      addBusTramStation: (newPoint: BusTramStationFeature) =>
        set((state) => ({
          ...state,
          addedBusTramStations: [...state.addedBusTramStations, newPoint],
        })),
      addMcdStation: (newPoint: McdStationFeature) =>
        set((state) => ({
          ...state,
          addedMcdStations: [...state.addedMcdStations, newPoint],
        })),
      addMckStation: (newPoint: MckStationFeature) =>
        set((state) => ({
          ...state,
          addedMckStations: [...state.addedMckStations, newPoint],
        })),
      addMetroStation: (newPoint: MetroStationFeature) =>
        set((state) => ({
          ...state,
